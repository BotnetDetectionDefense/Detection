...
for packet in cap:
    ...
    try:
        ...
        pass
    #query = "INSERT INTO ctu13 (durat, prot, srcip, srcport, dstport, flags, tos, packets, bytes, flows) VALUES ( \'" + Duration + "\',\'" + Protocol + "\',\'" + SourceIP + "\',\'" + SourcePort + "\',\'" + DestinationPort + "\',\'" + Flags + "\',\'" + ToS + "\',\'" + Length + "\',\'" + Bytes + "\',\'" + Flows + "\');"
    query = "INSERT INTO CapturedTraffic (duration, protocol, sourcemac, sourceip, sourceport, destinationmac, destinationip, destinationport, flags, tos, packets, bytes, flows) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    #print(query)
    args = (Duration, Protocol, EthSource, SourceIP, SourcePort, EthDestination, DestinationIP, DestinationPort, Flags, ToS, Length, Bytes, Flows)
